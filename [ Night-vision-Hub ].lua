...
-- ปรับแสงเริ่มต้น
			local Lighting = game:GetService("Lighting")
			Lighting.ExposureCompensation = 0.5 -- เริ่มต้น

			-- UI Container
local brightnessFrame = Instance.new("Frame")
brightnessFrame.Size = UDim2.new(0, 340, 0, 200)
brightnessFrame.Position = UDim2.new(0.5, 0, 0.55, 0) -- กลางหน้าจอ
...
plusBtn.Size = UDim2.new(0.45, -10, 0, 40)
plusBtn.Position = UDim2.new(0, 10, 0, 70)
...
minusBtn.Size = UDim2.new(0.45, -10, 0, 40)
...
plusBtn.MouseButton1Click:Connect(function()
	local newValue = math.clamp(Lighting.ExposureCompensation + 0.5, -20, 20)
